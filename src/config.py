...
APPROACH = "4-Context Framework: Category + Merchant + Trigger + Customer contexts fed to LLM with few-shot examples. Improved STOP handling and contextual replies."
CONTACT_EMAIL = "hpmayankmaurya@gmail.com"
VERSION = "1.2.0"
FRONTEND_URL = "https://vera-bot-eight.vercel.app"
